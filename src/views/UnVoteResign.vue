                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent pb-2">
                        <h3 class="text-muted mb-2">
                            <i class="fas fa-sign-out-alt text-warning" aria-hidden="true"></i> UnVote Resign
                        </h3>
                    </div>
                    <div class="card-body px-lg-4 py-lg-4">
                        <form role="form">
                            ...
                            <div class="text-center">
                                <base-button type="danger" class="my-2" @click="unvote">UnVote Resign</base-button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async unvote() {
        await this.contract.unVoteResign(this.address)
      }
    },
    async mounted() {
